...
let keywords =
  ...
  Array.iter
    ...
    [| ("int" , TYPE (Ty_int))
     ...
     ; ("int.gt_s", RELOP (Ty_int, Gt))
     ; ("int.ge", RELOP (Ty_int, Ge))
     ; ("int.ge_s", RELOP (Ty_int, Ge))
     ...
     ; ("real.gt_s", RELOP (Ty_real, Gt))
     ; ("real.ge", RELOP (Ty_real, Ge))
     ; ("real.ge_s", RELOP (Ty_real, Ge))
     ...
     ; ("i32.gt_s", RELOP (Ty_bitv 32, Gt))
     ; ("i32.ge_u", RELOP (Ty_bitv 32, GeU))
     ; ("i32.ge", RELOP (Ty_bitv 32, Ge))
     ; ("i32.ge_s", RELOP (Ty_bitv 32, Ge))
     ...
     ; ("i64.gt_s", RELOP (Ty_bitv 64, Gt))
     ; ("i64.ge_u", RELOP (Ty_bitv 64, GeU))
     ; ("i64.ge", RELOP (Ty_bitv 64, Ge))
     ; ("i64.ge_s", RELOP (Ty_bitv 64, Ge))
     ...
     ; ("f32.gt_s", RELOP (Ty_fp 32, Gt))
     ; ("f32.ge", RELOP (Ty_fp 32, Ge))
     ; ("f32.ge_s", RELOP (Ty_fp 32, Ge))
     ...
     ; ("f64.gt_s", RELOP (Ty_fp 64, Gt))
     ; ("f64.ge", RELOP (Ty_fp 64, Ge))
     ; ("f64.ge_s", RELOP (Ty_fp 64, Ge))
