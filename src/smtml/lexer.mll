...
let keywords =
  ...
  Array.iter
    ...
    [| ("int" , TYPE (Ty_int))
     ...
     ; ("real.div_s", BINARY (Ty_real, Div))
     ; ("real.mul", BINARY (Ty_real, Mul))
     ; ("real.rem", BINARY (Ty_real, Rem))
     ; ("real.rem_s", BINARY (Ty_real, Rem))
     ...
     ; ("real.lt_s", RELOP (Ty_real, Lt))
     ; ("real.le", RELOP (Ty_real, Le))
     ; ("real.le_s", RELOP (Ty_real, Le))
     ...
     ; ("i32.shr_s", BINARY (Ty_bitv 32, ShrA))
     ; ("i32.shr_u", BINARY (Ty_bitv 32, ShrL))
     ; ("i32.rem", BINARY (Ty_bitv 32, Rem))
     ; ("i32.rem_s", BINARY (Ty_bitv 32, Rem))
     ; ("i32.rem_u", BINARY (Ty_bitv 32, RemU))
     ; ("i32.mod", BINARY (Ty_bitv 32, Mod))
     ; ("i32.rotr", FAKE_BINARY (Ty_bitv 32, Rotr 0))
     ; ("i32.rotl", FAKE_BINARY (Ty_bitv 32, Rotl 0))
     ; ("i32.ext_rotr", BINARY (Ty_bitv 32, Ext_rotr))
     ; ("i32.ext_rotl", BINARY (Ty_bitv 32, Ext_rotl))
     ; ("i32.eq", RELOP (Ty_bool, Eq))
     ; ("i32.ne", RELOP (Ty_bool, Ne))
     ; ("i32.lt_u", RELOP (Ty_bitv 32, LtU))
     ; ("i32.lt", RELOP (Ty_bitv 32, Lt))
     ; ("i32.lt_s", RELOP (Ty_bitv 32, Lt))
     ; ("i32.le_u", RELOP (Ty_bitv 32, LeU))
     ; ("i32.le", RELOP (Ty_bitv 32, Le))
     ; ("i32.le_s", RELOP (Ty_bitv 32, Le))
     ...
     ; ("i64.shr_s", BINARY (Ty_bitv 64, ShrA))
     ; ("i64.shr_u", BINARY (Ty_bitv 64, ShrL))
     ; ("i64.rem", BINARY (Ty_bitv 64, Rem))
     ; ("i64.rem_s", BINARY (Ty_bitv 64, Rem))
     ; ("i64.rem_u", BINARY (Ty_bitv 64, RemU))
     ; ("i64.mod", BINARY (Ty_bitv 64, Mod))
     ; ("i64.rotr", FAKE_BINARY (Ty_bitv 64, Rotr 0))
     ; ("i64.rotl", FAKE_BINARY (Ty_bitv 64, Rotl 0))
     ; ("i64.ext_rotr", BINARY (Ty_bitv 64, Ext_rotr))
     ; ("i64.ext_rotl", BINARY (Ty_bitv 64, Ext_rotl))
     ; ("i64.eq", RELOP (Ty_bool, Eq))
     ; ("i64.ne", RELOP (Ty_bool, Ne))
     ; ("i64.lt_u", RELOP (Ty_bitv 64, LtU))
     ; ("i64.lt", RELOP (Ty_bitv 64, Lt))
     ; ("i64.lt_s", RELOP (Ty_bitv 64, Lt))
     ; ("i64.le_u", RELOP (Ty_bitv 64, LeU))
     ; ("i64.le", RELOP (Ty_bitv 64, Le))
     ; ("i64.le_s", RELOP (Ty_bitv 64, Le))
