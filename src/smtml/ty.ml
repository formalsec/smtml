...
let of_string = function
  ...
  | "RoundingMode" -> Ok (Ty Ty_roundingMode)
  | s ->
...
module Unop = struct
  ...
  and _ op =
    ...
    | Is_nan : [< `Ty_real | `Ty_fp | `Ty_none ] op
    | Is_zero : [< `Ty_fp | `Ty_none ] op
    | Ceil : [< `Ty_real | `Ty_fp | `Ty_none ] op
    | Floor : [< `Ty_real | `Ty_fp | `Ty_none ] op
    | Trunc : [< `Ty_real | `Ty_fp | `Ty_none ] op
