...
let test_binop_string () =
  ...
  assert_equal
    (Expr.binop ty String_prefix (string "ab") (string "abcd"))
    (true_ ());
  assert_equal
...
let test_relop_bool () =
  let open Infix in
  let ty = Ty.Ty_bool in
  assert_equal (Expr.relop ty Eq (int 0) (int 0)) Expr.Bool.true_;
  assert_equal (Expr.relop ty Ne (int 0) (int 0)) Expr.Bool.false_;
  assert_equal (Expr.relop ty Eq (real 0.0) (real 0.0)) Expr.Bool.true_;
  assert_equal (Expr.relop ty Ne (real 0.0) (real 0.0)) Expr.Bool.false_;
  assert_equal (Expr.relop ty Eq (int32 0l) (int32 0l)) Expr.Bool.true_;
  assert_equal (Expr.relop ty Ne (int32 0l) (int32 0l)) Expr.Bool.false_;
  assert_equal (Expr.relop ty Eq (int64 0L) (int64 0L)) Expr.Bool.true_;
  assert_equal (Expr.relop ty Ne (int64 0L) (int64 0L)) Expr.Bool.false_
...
let test_relop_int () =
  let open Infix in
  let ty = Ty.Ty_int in
  assert_equal (Expr.relop ty Lt (int 0) (int 1)) Expr.Bool.true_;
  assert_equal (Expr.relop ty Le (int 0) (int 1)) Expr.Bool.true_;
  assert_equal (Expr.relop ty Gt (int 0) (int 1)) Expr.Bool.false_;
  assert_equal (Expr.relop ty Ge (int 0) (int 1)) Expr.Bool.false_

let test_relop_real () =
  let open Infix in
  let ty = Ty.Ty_real in
  let x = symbol "x" ty in
  assert_equal (Expr.relop Ty_bool Ne (real Float.nan) x) Expr.Bool.true_;
  assert_equal (Expr.relop Ty_bool Eq x (real Float.nan)) Expr.Bool.false_;
  assert_equal (Expr.relop ty Lt (real 0.0) (real 1.0)) Expr.Bool.true_;
  assert_equal (Expr.relop ty Le (real 0.0) (real 1.0)) Expr.Bool.true_;
  assert_equal (Expr.relop ty Gt (real 0.0) (real 1.0)) Expr.Bool.false_;
  assert_equal (Expr.relop ty Ge (real 0.0) (real 1.0)) Expr.Bool.false_

let test_relop_string () =
  let open Infix in
  let ty = Ty.Ty_str in
  assert_equal (Expr.relop ty Lt (string "a") (string "b")) Expr.Bool.true_;
  assert_equal (Expr.relop ty Le (string "a") (string "b")) Expr.Bool.true_;
  assert_equal (Expr.relop ty Gt (string "a") (string "b")) Expr.Bool.false_;
  assert_equal (Expr.relop ty Ge (string "a") (string "b")) Expr.Bool.false_;
  assert_equal (Expr.relop ty Eq (string "a") (string "a")) Expr.Bool.true_;
  assert_equal (Expr.relop ty Ne (string "a") (string "a")) Expr.Bool.false_;
  assert_equal (Expr.relop ty Eq (string "a") (string "b")) Expr.Bool.false_;
  assert_equal (Expr.relop ty Ne (string "a") (string "b")) Expr.Bool.true_
...
let test_relop_f32 () =
  ...
  assert_equal (Expr.relop ty Eq nan0 nan1) Expr.Bool.false_;
  assert_equal (Expr.relop ty Lt (float32 0.0) (float32 1.0)) Expr.Bool.true_;
  assert_equal (Expr.relop ty Le (float32 0.0) (float32 1.0)) Expr.Bool.true_;
  assert_equal (Expr.relop ty Gt (float32 0.0) (float32 1.0)) Expr.Bool.false_;
  assert_equal (Expr.relop ty Ge (float32 0.0) (float32 1.0)) Expr.Bool.false_

let test_relop_f64 () =
  let open Infix in
  let ty = Ty.Ty_fp 64 in
  assert_equal (Expr.relop ty Lt (float64 0.0) (float64 1.0)) Expr.Bool.true_;
  assert_equal (Expr.relop ty Le (float64 0.0) (float64 1.0)) Expr.Bool.true_;
  assert_equal (Expr.relop ty Gt (float64 0.0) (float64 1.0)) Expr.Bool.false_;
  assert_equal (Expr.relop ty Ge (float64 0.0) (float64 1.0)) Expr.Bool.false_
...
let test_relop_ptr () =
  ...
  assert_equal (Expr.relop Ty_bool Eq p0 p0) Expr.Bool.true_;
  assert_equal (Expr.relop Ty_bool Eq p0 p1) Expr.Bool.false_;
  assert_equal (Expr.relop Ty_bool Ne p0 p0) Expr.Bool.false_;
  assert_equal (Expr.relop Ty_bool Ne p0 p1) Expr.Bool.true_;
  assert_equal (Expr.relop ty LtU p0 p0) Expr.Bool.false_;
  assert_equal (Expr.relop ty LeU p0 p1) Expr.Bool.true_;
  assert_equal (Expr.relop ty GeU p0 p0) Expr.Bool.true_;
  assert_equal (Expr.relop ty GtU p0 p1) Expr.Bool.false_;
  assert_equal (Expr.relop ty Le p0 (int32 4l)) Expr.Bool.true_;
  assert_equal (Expr.relop ty Lt (int32 4l) p0) Expr.Bool.false_;
  assert_equal (Expr.relop ty Gt p1 (int32 4l)) Expr.Bool.false_;
  assert_equal (Expr.relop ty Ge (int32 4l) p1) Expr.Bool.true_
...
let test_naryop_bool () =
  ...
  let t = true_ () in
  let f = false_ () in
  assert_equal (Expr.naryop ty Logand [ t; t; t; t ]) t;
  assert_equal (Expr.naryop ty Logor [ f; f; f; f ]) f;
  assert_equal (Expr.naryop ty Logand [ t; f; t ]) f;
  assert_equal (Expr.naryop ty Logor [ f; t; f ]) t
...
let () =
  try
    ...
    test_naryop ();
    test_simplify ()
  with Eval.TypeError { index; value; ty; _ } ->
    Fmt.failwith "type error: operator %a argument %d got unexpected value %a"
      Ty.pp ty index Value.pp value
