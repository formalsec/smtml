...
module Infix = struct
  ...
  let ( = ) i1 i2 = binop Ty_bool Eq i1 i2

  let ( <> ) i1 i2 = binop Ty_bool Ne i1 i2
  ...
  module Int = struct
    ...
    let ( < ) i1 i2 = binop Ty_int Lt i1 i2

    let ( > ) i1 i2 = binop Ty_int Gt i1 i2

    let ( <= ) i1 i2 = binop Ty_int Le i1 i2

    let ( >= ) i1 i2 = binop Ty_int Ge i1 i2

    let to_real i = unop Ty_real Reinterpret_int i
  end
end
