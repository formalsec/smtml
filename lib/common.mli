...
val string_binds : Model.model -> (string * Types.expr_type) list -> (string * string * string) list
val value_binds : Model.model -> (string * Types.expr_type) list -> (string * Num.t) list
