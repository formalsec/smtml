...
let unop =
  op Int.unop Real.unop Bool.unop Str.unop Lst.unop Tuple.unop I32.unop I64.unop
    F32.unop F64.unop

let binop =
  op Int.binop Real.binop Bool.binop Str.binop Lst.binop Tuple.binop I32.binop
    I64.binop F32.binop F64.binop
