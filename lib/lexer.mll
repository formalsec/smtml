...
let keywords =
  ...
  Array.iter
    ...
    [| ("int" , TYPE (Ty_int))
     ...
     ; ("str.len", UNARY (Ty_str, Seq_length))
     ; ("str.at", BINARY (Ty_str, Seq_at))
     ; ("str.++", BINARY (Ty_str, Seq_concat))
     ; ("str.prefixof", BINARY (Ty_str, Seq_prefix))
     ; ("str.suffixof", BINARY (Ty_str, Seq_suffix))
     ; ("str.contains", BINARY (Ty_str, Seq_contains))
     ; ("str.substr", TERNARY (Ty_str, Seq_extract))
     ; ("str.replace", TERNARY (Ty_str, Seq_replace))
     ; ("str.indexof", TERNARY (Ty_str, Seq_index))
