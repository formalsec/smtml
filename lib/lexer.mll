...
let keywords =
  ...
  Array.iter
    ...
    [| ("int" , TYPE (Ty_int))
     ...
     ; ("=", BINARY (Ty_bool, Eq))
     ; ("bool.eq", BINARY (Ty_bool, Eq)) (* To deprecate *)
     ; ("distinct", BINARY (Ty_bool, Ne))
     ; ("bool.ne", BINARY (Ty_bool, Ne)) (* To deprecate *)
     ...
     ; ("int.eq", BINARY (Ty_bool, Eq))
     ; ("int.ne", BINARY (Ty_bool, Ne))
     ; ("int.lt", BINARY (Ty_int, Lt))
     ; ("int.le", BINARY (Ty_int, Le))
     ; ("int.gt", BINARY (Ty_int, Gt))
     ; ("int.ge", BINARY (Ty_int, Ge))
     ; ("int.to_string", UNARY (Ty_int, ToString))
     ; ("int.of_string", UNARY (Ty_int, OfString))
     ; ("int.reinterpret_real", UNARY (Ty_int, Reinterpret_float))
     ...
     ; ("real.eq", BINARY (Ty_bool, Eq))
     ; ("real.ne", BINARY (Ty_bool, Ne))
     ; ("real.lt", BINARY (Ty_real, Lt))
     ; ("real.le", BINARY (Ty_real, Le))
     ; ("real.gt", BINARY (Ty_real, Gt))
     ; ("real.ge", BINARY (Ty_real, Ge))
     ; ("real.reinterpret_int", UNARY (Ty_real, Reinterpret_int))
     ; ("real.to_string", UNARY (Ty_real, ToString))
     ; ("real.of_string", UNARY (Ty_real, OfString))
     ; ("str.len", UNARY (Ty_str, Length))
     ; ("str.at", BINARY (Ty_str, At))
     ; ("str.++", NARY (Ty_str, Concat))
     ; ("str.trim", UNARY (Ty_str, String_trim))
     ...
     ; ("str.to_code", UNARY (Ty_str, String_to_code))
     ; ("str.from_code", UNARY (Ty_str, String_from_code))
     ; ("str.to_int", UNARY (Ty_str, String_to_int))
     ; ("str.from_int", UNARY (Ty_str, String_from_int))
     ...
     ; ("i32.eq", BINARY (Ty_bool, Eq))
     ; ("i32.ne", BINARY (Ty_bool, Ne))
     ; ("i32.lt_u", BINARY (Ty_bitv 32, LtU))
     ; ("i32.lt", BINARY (Ty_bitv 32, Lt))
     ; ("i32.le_u", BINARY (Ty_bitv 32, LeU))
     ; ("i32.le", BINARY (Ty_bitv 32, Le))
     ; ("i32.gt_u", BINARY (Ty_bitv 32, GtU))
     ; ("i32.gt", BINARY (Ty_bitv 32, Gt))
     ; ("i32.ge_u", BINARY (Ty_bitv 32, GeU))
     ; ("i32.ge", BINARY (Ty_bitv 32, Ge))
     ; ("i32.to_bool", UNARY (Ty_bitv 32, ToBool))
     ; ("i32.of_bool", UNARY (Ty_bitv 32, OfBool))
     ; ("i32.trunc_f32_s",  UNARY (Ty_bitv 32, TruncSF32))
     ; ("i32.trunc_f32_u", UNARY (Ty_bitv 32, TruncUF32))
     ; ("i32.trunc_f64_s", UNARY (Ty_bitv 32, TruncSF64))
     ; ("i32.trunc_f64_u", UNARY (Ty_bitv 32, TruncUF64))
     ; ("i32.reinterpret_float", UNARY (Ty_bitv 32, Reinterpret_float))
     ; ("i32.wrap_i64", UNARY (Ty_bitv 32, WrapI64))
     ; ("i32.extend_i16_s", UNARY (Ty_bitv 32, Sign_extend 16))
     ; ("i32.extend_i16_u", UNARY (Ty_bitv 32, Zero_extend 16))
     ; ("i32.extend_i24_s", UNARY (Ty_bitv 32, Sign_extend 24))
     ; ("i32.extend_i24_u", UNARY (Ty_bitv 32, Zero_extend 24))
     ...
     ; ("i64.eq", BINARY (Ty_bool, Eq))
     ; ("i64.ne", BINARY (Ty_bool, Ne))
     ; ("i64.lt_u", BINARY (Ty_bitv 64, LtU))
     ; ("i64.lt", BINARY (Ty_bitv 64, Lt))
     ; ("i64.le_u", BINARY (Ty_bitv 64, LeU))
     ; ("i64.le", BINARY (Ty_bitv 64, Le))
     ; ("i64.gt_u", BINARY (Ty_bitv 64, GtU))
     ; ("i64.gt", BINARY (Ty_bitv 64, Gt))
     ; ("i64.ge_u", BINARY (Ty_bitv 64, GeU))
     ; ("i64.ge", BINARY (Ty_bitv 64, Ge))
     ; ("i64.trunc_f32_s",  UNARY (Ty_bitv 64, TruncSF32))
     ; ("i64.trunc_f32_u", UNARY (Ty_bitv 64, TruncUF32))
     ; ("i64.trunc_f64_s", UNARY (Ty_bitv 64, TruncSF64))
     ; ("i64.trunc_f64_u", UNARY (Ty_bitv 64, TruncUF64))
     ; ("i64.reinterpret_float", UNARY (Ty_bitv 64, Reinterpret_float))
     ; ("i64.extend_i32_s", UNARY (Ty_bitv 64, Sign_extend 32))
     ; ("i64.extend_i32_u", UNARY (Ty_bitv 64, Zero_extend 32))
     ...
     ; ("f32.eq", BINARY (Ty_fp 32, Eq))
     ; ("f32.ne", BINARY (Ty_fp 32, Ne))
     ; ("f32.lt", BINARY (Ty_fp 32, Lt))
     ; ("f32.le", BINARY (Ty_fp 32, Le))
     ; ("f32.gt", BINARY (Ty_fp 32, Gt))
     ; ("f32.ge", BINARY (Ty_fp 32, Ge))
     ; ("f32.convert_i32_s", UNARY (Ty_fp 32, ConvertSI32))
     ; ("f32.convert_i32_u", UNARY (Ty_fp 32, ConvertUI32))
     ; ("f32.convert_i64_s", UNARY (Ty_fp 32, ConvertSI32))
     ; ("f32.demote_f64", UNARY (Ty_fp 32, DemoteF64))
     ; ("f32.reinterpret_int", UNARY (Ty_fp 32, Reinterpret_int))
     ...
     ; ("f64.eq", BINARY (Ty_fp 64, Eq))
     ; ("f64.ne", BINARY (Ty_fp 64, Ne))
     ; ("f64.lt", BINARY (Ty_fp 64, Lt))
     ; ("f64.le", BINARY (Ty_fp 64, Le))
     ; ("f64.gt", BINARY (Ty_fp 64, Gt))
     ; ("f64.ge", BINARY (Ty_fp 64, Ge))
     ; ("f64.convert_i32_s", UNARY (Ty_fp 64, ConvertSI32))
     ; ("f64.convert_i32_u", UNARY (Ty_fp 64, ConvertUI32))
     ; ("f64.convert_i64_s", UNARY (Ty_fp 64, ConvertSI32))
     ; ("f64.promote_f32", UNARY (Ty_fp 64, PromoteF32))
     ; ("f64.reinterpret_int", UNARY (Ty_fp 64, Reinterpret_int))
     ; ("extract", EXTRACT)
     ; ("++", CONCAT)
     ; ("Ptr", PTR)
     ; ("assert", ASSERT)
